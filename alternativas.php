...
<div class="container">
	...
	<button class="btn btn-primary" data-toggle="modal" data-target="#modalalternativas"><i class="fas fa-plus"></i></button>
</div>
<!-- Modal Alternativas -->
<div class="modal fade" id="modalalternativas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
